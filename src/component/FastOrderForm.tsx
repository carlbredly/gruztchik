...
export default function FastOrderForm() {
  ...
  return (
    <div className="w-full lg:max-w-md p-4 sm:p-6 bg-white rounded-3xl shadow-lg space-y-3 sm:space-y-4">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold uppercase mb-4 sm:mb-5">Contact us</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
        <div className="flex flex-col flex-1">
          <label className="text-xs sm:text-sm mb-1">Nombre de personnes</label>
        ...
        <div className="flex flex-col flex-1">
          <label className="text-xs sm:text-sm mb-1">Nombre d'heures</label>
          <div className="flex items-center border border-gray-200 rounded-lg px-3 py-2 justify-between bg-[#bcbce029]">
      ...
      <p className="text-xs text-gray-500 text-center leading-relaxed">
        En cliquant sur le bouton, vous acceptez les conditions d'utilisation et la politique de confidentialité.
      </p>
    </div>
  );
}
